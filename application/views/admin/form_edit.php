...
<div class="form-group row align-items-center">
	...
	<div class="col-sm-9">
		<input type="number" class="form-control" required readonly="" name="x" id="x-edit" value="<?= $l->x ?>">
	</div>
</div>
<div class="form-group row align-items-center">
	<label for="gudang" class="col-sm-3 col-form-label">Longitude</label>
	<div class="col-sm-9">
		<input type="number" class="form-control" required readonly="" name="y" id="y-edit" value="<?= $l->y ?>">
	</div>
</div>
<div class="form-group row align-items-center">
