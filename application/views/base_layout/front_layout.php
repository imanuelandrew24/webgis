			...
			<div class="scroll-sidebar">
				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav">
							...
							<div class="user-profile d-flex no-block dropdown mt-3">
								...
								<div class="user-content hide-menu ml-2">
									<a onclick="return false" class="" id="Userdd" role="button" aria-haspopup="true" aria-expanded="false">
										<h5 class="mb-0 user-name font-medium">Guest
									</a>
								</div>
							</div>
							<!-- End User Profile-->
						...
						<li class="sidebar-item"><a href="<?php echo site_url('home') ?>" class="sidebar-link"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu"> Home</span></a></li>
						<li class="sidebar-item"><a href="<?php echo site_url('dataternak') ?>" class="sidebar-link"><i class="mdi mdi-table"></i><span class="hide-menu"> Data Peternakan</span></a></li>
						<li class="sidebar-item"><a href="<?php echo site_url('profile') ?>" class="sidebar-link"><i class="fa fa-user"></i><span class="hide-menu"> Profil Instansi</span></a></li>
						<li class="sidebar-item"><a href="<?= site_url('login') ?>" class="sidebar-link"><i class="mdi mdi-login"></i><span class="hide-menu"> Login Administrator</span></a></li>
